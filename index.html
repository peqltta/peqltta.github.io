                        ...
                        <ul id="tm-main-nav">
                            ...
                            <li class="nav-item">
                                <a href="#gallery" class="nav-link">
                                    <div class="triangle-right"></div>
                                    <i class="fas fa-images nav-icon"></i> Projects
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#about" class="nav-link">
                                    <div class="triangle-right"></div>
                                    <i class="fas fa-user-friends nav-icon"></i> About
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link external" target="_parent" rel="sponsored">
                                    <div class="triangle-right"></div>
                                    <i class="fas fa-external-link-alt nav-icon"></i> External
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="tm-main">
                            ...
                            <div class="tm-col-home tm-col-home-l">
                                <div class="media mb-4">
                                    ...
                                    <div class="media-body">
                                        <a href="#" class="d-block mb-2 tm-text-primary tm-post-link">25th June 2021</a>
                                        <p>
                                            Blog post, hi how are you </p>
                                    </div>
                                </div>
                                <div class="media mb-4">
                                    <i class="fas fa-cloud-sun fa-4x tm-post-icon tm-text-primary"></i>
                                    <div class="media-body">
                                        <a href="#" class="d-block mb-2 tm-text-primary tm-post-link">20th June 2021</a>
                                        <p>
                                            An older blog post 😂
                                        </p>
                                    </div>
                ...
                <div class="tm-section-wrap">
                    ...
                    <section id="gallery" class="tm-section">
                        <h2 class="tm-text-primary">Aidans Projects</h2>
                        <hr class="mb-5">
                        <ul class="tm-gallery-links">
                            ...
                            <li>
                                <a href="javascript:void(0);" class="tm-gallery-link" data-filter="portrait">
                                    <i class="fas fa-portrait tm-gallery-link-icon"></i> HTML5 / CSS
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="tm-gallery-link" data-filter="nature">
                                    <i class="fas fa-leaf tm-gallery-link-icon"></i> Python
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="tm-gallery-link" data-filter="animal">
                                    <i class="fas fa-paw tm-gallery-link-icon"></i> AWS
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" class="tm-gallery-link" data-filter="building">
                                    <i class="far fa-building tm-gallery-link-icon"></i> Other
                                </a>
                            </li>
                        </ul>
                ...
                <div class="tm-section-wrap">
                    ...
                    <section id="about" class="tm-section">
                        <h2 class="tm-text-primary">About Aidan</h2>
                        <hr class="mb-5">
                        <div class="row tm-row-about">
                            <div class="tm-col-about tm-col-about-l">
                                <p class="mb-4">
                                    <a href="https://www.linkedin.com/in/aidan-broadbent-4a6509213/">Linked In</a>
                                </p>
                                <p class="mb-4">
                                    Currently studying blabla etc.
                                </p>
                            </div>
                    ...
                    <div id="contact" class="tm-section">
                        ...
                        <div class="row">
                                ...
                                <form id="contact-form" action="" method="POST" class="tm-contact-form">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="contact-select" name="inquiry">
                                            ...
                                            <option value="ph">Project Help</option>
                                            <option value="ci">Code Issue</option>
                            ...
                            -->
                                <!-- Address -->
                                <address class="mb-4">
                                    123 Fake Street, You think you'd find this here?
                                </address>

                                <!-- Links -->
                                <ul class="tm-contact-links mb-4">
                                    <li class="mb-2">
                                        <a href="tel:0123456765484">
                                            <i class="fas fa-phone mr-2 tm-contact-link-icon"></i> Tel: 0123456765484
                                        </a>
                                    </li>
                                    <li>
                                        <a href="mailto:aidanpbroadbent@gmail.com">
                                            <i class="fas fa-at mr-2 tm-contact-link-icon"></i> Email: aidanpbroadbent@gmail.com
                                        </a>
                                    </li>
                                </ul>
                                <!--
